    ...
    return html`
            <style>
                ...
                .interactive-item:hover {
                    border:var(--auto-hover-border)!important;;
            ...
            <div class="auto-card">
                ...
                <div class="auto-card-body col">
                    ...
                    </div><div class="auto-card-body-item" style="background-color:var(--auto-secondary-bgcolor);border:var(--auto-border)">
                        面板次背景: var(--auto-secondary-bgcolor)
                    </div>
            ...
            <div class="auto-card">
                ...
                <div class="auto-card-body col">
                    <div class="auto-card-body-item" style="flex-direction:column; color:var(--auto-color);background-color:var(--auto-bgcolor)">
                        主要文字: var(--auto-color)                   
                        <p  style="color:var(--auto-secondary-color); ">
            ...
            <div class="auto-card">
                ...
                <div class="auto-card-body col">
                    ...
                    <div class="auto-card-body-item " style="color:var(--auto-active-color);background-color:var(--auto-active-bgcolor);border:var(--auto-active-border)">
                        激活:  查看 active 效果
                    </div>
